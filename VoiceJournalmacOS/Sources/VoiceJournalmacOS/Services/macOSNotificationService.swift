...
/// macOS notification service (notifications work differently on macOS)
public final class macOSNotificationService: NotificationServiceProtocol, Sendable {
    public static let shared = macOSNotificationService()
